        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form method="post" action="{{ url('/ikan/store') }}">
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="namaIkan">Nama Ikan</label>
                    <input type="text" class="form-control" name="namaIkan" id="namaIkan" value="{{ old('namaIkan') }}">
                        @error('namaIkan')
                  ...
                  <div class="form-group">
                    ...
                    <p for="exluasLahan" style="color: grey; font-size: small;">*meter persegi</p>
                        @error('luasLahan')
                        <p style="color: red; font-size: small;">{{ $message }}</p>
                        @enderror
                  </div>
