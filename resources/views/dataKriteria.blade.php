            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <thead>
                  ...
                  <tbody>
                    @foreach($ll as $j => $luas_lahan)
                  <tr>
                    <td>{{ $luas_lahan->id }}</td>
                    <td>Luas Lahan</td>
                    <td>{{ $luas_lahan->luas }}</td>
                  </tr>
                  @endforeach

                  @foreach($bi as $k => $berat_ideal)
                  <tr>
                    <td>{{ $berat_ideal->id }}</td>
                    <td>Berat Ideal</td>
                    <td>{{ $berat_ideal->berat }}</td>
                  </tr>
                  @endforeach

                  @foreach($jp as $l => $jenis_perairan)
                  <tr>
                    <td>{{ $jenis_perairan->id }}</td>
                    <td>Jenis Perairan</td>
                    <td>{{ $jenis_perairan->perairan }}</td>
                  </tr>
                  @endforeach

                  @foreach($ja as $m => $jenis_air)
                  <tr>
                    <td>{{ $jenis_air->id }}</td>
                    <td>Jenis Air</td>
                    <td>{{ $jenis_air->air }}</td>
                  ...
                  @foreach($mp as $n => $masa_panen)
                  <tr>
                    <td>{{ $masa_panen->id }}</td>
                    <td>Masa Panen</td>
                    <td>{{ $masa_panen->panen }}</td>
                  </tr>
                  @endforeach
                  </tbody>
                </table>
