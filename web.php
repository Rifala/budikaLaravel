...
Route::controller(UserController::class)->group(function(){
    ...
    Route::get('pembudidaya/blog','blog');
    Route::get('pembudidaya/contact','contact');
    Route::get('pembudidaya/home','home');
    Route::get('pembudidaya/konsultasi','konsultasi');
    Route::get('pembudidaya/spk','spk');
});
